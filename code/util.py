...
def cal1(project_list, level): # method 355  file 214
    ...
    if level == "method":
        ...
        oo = 214
    csv_root = "F:\\myPythonProjects\\TraceabilityAssociation\\result\\"
    gt_root = "F:\\myPythonProjects\\TraceabilityAssociation\\gt\\"
    d = defaultdict(int)
    p = list()
    test_list = list()
...
if __name__ == "__main__":
    ...
    # project_dir = r"F:\myPythonProjects\test_projects\flask"
    # print(get_files(project_dir))
    # print(get_test_files(project_dir))
    # print(get_production_files(project_dir))
